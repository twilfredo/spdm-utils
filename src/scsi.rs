...
impl SgCmd {
    ...
    fn gen_libspdm_request(
        ...
        let mut sg_cmd = SgCmd::new(cdb_len, direction, bufsz)?;
        let hdr = unsafe { *(header.as_mut_ptr() as *mut spdm_storage_transport_virtual_header_t) };
    ...
    fn gen_libspdm_response(
        ...
        let hdr =
            unsafe { *(transp_msg.as_mut_ptr() as *mut spdm_storage_transport_virtual_header_t) };
